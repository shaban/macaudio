...
char *IntrospectAudioUnitsWithTimeout(const char *type, const char *subtype, const char *manufacturerID) {
    @autoreleasepool {
        ...
        dispatch_time_t timeout = dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0 * NSEC_PER_SEC));
